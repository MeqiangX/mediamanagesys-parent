package com.mingkai.mediamanagesyscommonapp.configuration;
...
public class Swagger2CommonConfig {
    ...
    public Docket createRestApi(){
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apis(RequestHandlerSelectors.basePackage("com.mingkai.mediamanagesyscommomapp"))
    ...
    private ApiInfo apiInfo(){
        return new ApiInfoBuilder()
                .title("电影院管理系统 公共模块 RestFul Apis")
